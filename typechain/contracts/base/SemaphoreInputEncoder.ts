...
export interface SemaphoreInputEncoderInterface extends utils.Interface {
  functions: {
    ...
    "_encodeInputs((uint256[8],uint256,uint256,uint256,uint256,bytes),uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [SemaphoreInputEncoder.ProofStruct, BigNumberish]
  ): string;
  encodeFunctionData(
